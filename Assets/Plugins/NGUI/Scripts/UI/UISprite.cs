...
public class UISprite : UIWidget
{
    ...
    public Material MogoMaterial;

    public Material MogoLakeBlueMat;
    public Material MogoGreenMat;
    public Material MogoDeepBlueMat;
    public Material MogoPurposeMat;
    public Material MogoOrangeMat;
    public Material MogoRedMat;
    public Material MogoYellowMat;
    public Material MogoRoseRedMat;
    public Material MogoGrassGreenMat;

    public Material MogoDragonGreenMat;
    public Material MogoDragonBlueMat;
    public Material MogoDragonPurposeMat;
    public Material MogoDragonOrangeMat;
    public Material MogoDragonDarkGoldMat;

    public Material MogoButtonWhite;
    public Material MogoButtonPurpose;
    public Material MogoButtonRoseRed;
    public Material MogoButtonRed;
    public Material MogoButtonDarkGold;
    public Material MogoButtonGreen;
    public Material MogoButtonBlue;
    public Material MogoButtonDeepBlue;
    public Material MogoButtonNormal;

    protected Texture m_oriTex;
    protected Texture m_oriAlphaTex;
 ...
 || !Application.isPlaying && (mOuter != mSprite.outer || mInner != mSprite.inner)
    ...
    public void RefreshAllShowAs()
    {
        ...
        ShowAsRoseRed();
        ShowAsGrassGreen(); 
        //ShowAsWhiteBlack(false, true);
        //ShowAsWhiteBlack(true, true);
    }

    public void ShowAsLakeBlue()
    {
        ShowAsColor("MogoLakeBlueMat.mat", MogoLakeBlueMat);
    }

    public void ShowAsGreen()
    {
        ShowAsColor("MogoGreenMat.mat", MogoGreenMat);
    }

    public void ShowAsDeepBlue()
    {
        ShowAsColor("MogoDeepBlueMat.mat", MogoDeepBlueMat);
    }

    public void ShowAsPurpose()
    {
        ShowAsColor("MogoPurposeMat.mat", MogoPurposeMat);
    }

    public void ShowAsOrange()
    {
        ShowAsColor("MogoOrangeMat.mat", MogoOrangeMat);
    }

    public void ShowAsRed()
    {
        ShowAsColor("MogoRedMat.mat", MogoRedMat);
    }

    public void ShowAsYellow()
    {
        ShowAsColor("MogoYellowMat.mat", MogoYellowMat);
    }

    public void ShowAsRoseRed()
    {
        ShowAsColor("MogoRoseRedMat.mat", MogoRoseRedMat);
    }

    public void ShowAsGrassGreen()
    {
        ShowAsColor("MogoGrassGreenMat.mat", MogoGrassGreenMat);
    }
    ...
    public void ShowAsDragonGreen()
    {
        ShowAsColor("MogoDragonGreenMat.mat", MogoDragonGreenMat);
    }

    public void ShowAsDragonBlue()
    {
        ShowAsColor("MogoDragonBlueMat.mat", MogoDragonBlueMat);
    }

    public void ShowAsDragonPurpose()
    {
        ShowAsColor("MogoDragonPurposeMat.mat", MogoDragonPurposeMat);
    }

    public void ShowAsDragonOrange()
    {
        ShowAsColor("MogoDragonOrangeMat.mat", MogoDragonOrangeMat);
    }

    public void ShowAsDragonDarkGold()
    {
        ShowAsColor("MogoDragonDarkGoldMat.mat", MogoDragonDarkGoldMat);
    }

    public void ShowAsButtonWhite()
    {
        ShowAsColor("MogoButtonWhite.mat", MogoButtonWhite);
    }

    public void ShowAsButtonPurpose()
    {
        ShowAsColor("MogoButtonPurple.mat", MogoButtonPurpose);
    }

    public void ShowAsButtonRoseRed()
    {
        ShowAsColor("MogoButtonRoseRed.mat", MogoButtonRoseRed);
    }

    public void ShowAsButtonRed()
    {
        ShowAsColor("MogoButtonRed.mat", MogoButtonRed);
    }

    public void ShowAsButtonDarkGold()
    {
        ShowAsColor("MogoButtonDarkGold.mat", MogoButtonDarkGold);
    }

    public void ShowAsButtonGreen()
    {
        ShowAsColor("MogoButtonGreen.mat", MogoButtonGreen);
    }

    public void ShowAsButtonBlue()
    {
        ShowAsColor("MogoButtonBlue.mat", MogoButtonBlue);
    }

    public void ShowAsButtonDeepBlue()
    {
        ShowAsColor("MogoButtonDeepBlue.mat", MogoButtonDeepBlue);
    }

    public void ShowAsButtonNormal()
    {
        ShowAsColor("MogoButtonNormal.mat", MogoButtonNormal);
    }
    ...
    private void ShowAsColor(string matName, Material colorMaterial)
    {
        if (!material)
        {
            Mogo.Util.LoggerHelper.Error("material null: " + gameObject);
            return;
        }
    ...
    public void RefreshRelatedPanel(GameObject go)
    {
        if (panelObj == null)
        {
        ...
        if (panelObj != null)
        {
            ...
            //panelObj.GetComponent<UIPanel>().Refresh();
        }
    }
