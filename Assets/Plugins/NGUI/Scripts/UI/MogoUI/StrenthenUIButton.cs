...
public class StrenthenUIButton : MonoBehaviour
{
    #region 公共变量
    ...
    void Awake()
    {
        gameObject.AddComponent<MogoFakeClick>().ReletedClassType = ReleadClassType.Type_StrenthUI;
    }
