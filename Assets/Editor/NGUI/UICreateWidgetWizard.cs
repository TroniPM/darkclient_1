...
public class UICreateWidgetWizard : EditorWindow
{
    ...
    static string mMogoTwoStatusButtonBGDown = "";
    static string mMogoTwoStatusButtonBGUp = "";
	...
	static void Save ()
	{
        ...
        SaveString("NGUI MogoTwoStatusButtonBGDown",mMogoTwoStatusButtonBGDown);
        SaveString("NGUI MogoTwoStatusButtonBGUp",mMogoTwoStatusButtonBGUp);
	}
	...
	static void Load ()
	{
        ...
        mMogoTwoStatusButtonBGDown = LoadString("NGUI MogoTwoStatusButtonDown");
        mMogoTwoStatusButtonBGUp = LoadString("NGUI MogoTwoStatusButtonUp");
	}
    ...
    void OnBGDown(string val) { mMogoTwoStatusButtonBGDown = val; Save(); Repaint(); }
    void OnBGUp(string val) { mMogoTwoStatusButtonBGUp = val; Save(); Repaint(); }
	/// <summary>
	...
	void OnGUI ()
	{
		...
		else
		{
			...
			switch (mType)
			{
                ...
                case WidgetType.MogoTwoStatusButton:    CreateMogoTwoStatusButton(go);break;
			}
		}
	}
}
