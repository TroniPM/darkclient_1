...
public class WingModelImageInMarket : MonoBehaviour 
{
    ...
    void OnEnable()
    {
        if (MogoWorld.thePlayer.vocation == Mogo.Game.Vocation.Assassin)
        {
            ...
            WingUIPreviewInMarketUIViewManager.Instance.LoadPlayerModel(2.43f, 0.49f, 0.42f, 0, 0.08f, 0f);
        }
        else if (MogoWorld.thePlayer.vocation == Mogo.Game.Vocation.Archer)
        {
            WingUIPreviewInMarketUIViewManager.Instance.LoadPlayerModel(2.75f, 0, 0.1f, 0);
        }
        else if (MogoWorld.thePlayer.vocation == Mogo.Game.Vocation.Mage)
        {
            WingUIPreviewInMarketUIViewManager.Instance.LoadPlayerModel(2.6f, 0, 0.15f, 0);
        }
        else
        {
            WingUIPreviewInMarketUIViewManager.Instance.LoadPlayerModel(2.82f, 0.53f, 0.59f, 0, 0.02f, 0.02f);
        }
    }

    void OnDisable()
    {
        WingUIPreviewInMarketUIViewManager.Instance.DisablePlayerModel();
    }
