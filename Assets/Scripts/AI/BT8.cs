...
{
	public sealed class BT8 : Mogo.AI.BehaviorTreeRoot
	{
		private static BT8 _instance = null;
		public static BT8 Instance
		{
			get
			{
				if(_instance == null)
		...
		{
			{
				...
				node1.AddChild(new Mogo.AI.CmpEnemyNum(Mogo.AI.CmpType.eq,0));
				{
					...
					node3.AddChild(new Mogo.AI.IsTargetCanBeAttack());
					{
						...
						node10.AddChild(new Mogo.AI.LookOn(450,150,800,30,1000,0,1500,0,1500,0,1000,70,0,1));
					}
				}
			}
		}
