...
{
	public sealed class BT10202 : Mogo.AI.BehaviorTreeRoot
	{
		private static BT10202 _instance = null;
		public static BT10202 Instance
		{
			get
			{
				if(_instance == null)
					_instance = new BT10202();
				...
				this.AddChild(node1);
				{
					...
					node2.AddChild(new Mogo.AI.IsTargetCanBeAttack());
					{
						...
						}
						{
							...
							node13.AddChild(new Mogo.AI.InSkillCoolDown(6));
							node13.AddChild(new Mogo.AI.InSkillRange(6));
							node13.AddChild(new Mogo.AI.CastSpell(6,0));
						...
						}
						{
							...
							node18.AddChild(new Mogo.AI.InSkillRange(5));
