...
{
	public sealed class BT10 : Mogo.AI.BehaviorTreeRoot
	{
		private static BT10 _instance = null;
		public static BT10 Instance
		{
			get
			{
				if(_instance == null)
		...
		{
			{
				...
				node1.AddChild(new Mogo.AI.CmpEnemyNum(Mogo.AI.CmpType.eq,0));
				{
					...
					node3.AddChild(new Mogo.AI.IsTargetCanBeAttack());
					{
						...
						node10.AddChild(new Mogo.AI.LookOn(500,350,500,40,500,15,500,5,500,5,1000,35,0,1));
					}
				}
