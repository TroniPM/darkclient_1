...
{
	public sealed class BT5 : Mogo.AI.BehaviorTreeRoot
	{
		private static BT5 _instance = null;
		public static BT5 Instance
		{
			get
			{
				if(_instance == null)
		...
		{
			{
				...
				node1.AddChild(new Mogo.AI.CmpEnemyNum(Mogo.AI.CmpType.eq,0));
				{
					...
					node3.AddChild(new Mogo.AI.IsTargetCanBeAttack());
					{
						...
						}
						{
							...
							node15.AddChild(new Mogo.AI.InSkillCoolDown(2));
							{
								...
								node15.AddChild(node17);
								{
									...
									node18.AddChild(new Mogo.AI.CmpRate(Mogo.AI.CmpType.lt,40));
						...
						node10.AddChild(new Mogo.AI.LookOn(450,150,800,30,1000,15,1500,0,1500,0,1000,55,0,1));
					}
				}
